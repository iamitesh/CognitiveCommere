    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col  footer-col box">
            <div className="social-links">
              ...
              <a href="https://www.instagram.com/cognitivebubble/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a href="https://in.linkedin.com/in/amitesh-anand-61a4b7164">
        ...
        <div className="row justify-content-center">
          <div className="col-12 text-white ">
            <span className="copyright quick-links flex-end">
              Copyright &copy; Amitesh Anand {new Date().getFullYear()}
            </span>
          </div>
        </div>
      </div>
